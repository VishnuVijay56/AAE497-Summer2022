...
def QuaternionToRotationMatrix(e_quaternion):
    ...
    # modify first row
    R_b_i[0][0] = e1**2 + e0**2 - e2**2 - e3**2
    R_b_i[0][1] = 2*(e1 * e2 - e3 * e0)
    R_b_i[0][2] = 2*(e1 * e3 + e2 * e0)

    # modify second row
    R_b_i[1][0] = R_b_i[0][1]
    R_b_i[1][1] = e2**2 + e0**2 - e1**2 - e3**2
    R_b_i[1][2] = 2*(e2 * e3 + e1 * e0)

    # modify third row
    R_b_i[2][0] = R_b_i[0][2]
    R_b_i[2][1] = R_b_i[1][2]
    R_b_i[2][2] = e3**2 + e0**2 - e1**2 - e2**2"""

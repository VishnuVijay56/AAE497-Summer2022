"""
SLC autopilot block for mavsim_python
...
class Autopilot:
    ...
    def update(self, cmd, state):
        ...
        altitude_c = self.saturate(cmd.altitude_command, state.altitude - 0.2*AP.altitude_zone, state.altitude + 0.2*AP.altitude_zone)
